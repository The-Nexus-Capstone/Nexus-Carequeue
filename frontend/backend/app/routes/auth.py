...
def login():
    ...
    if invite_code:
        ...
        return jsonify({
            ...
            'user': {
                'name': 'Guest Staff',
                'fullName': 'Guest Staff', # Match Dashboard.jsx
                'role': 'staff',
                'hospital': hospital.name,
                'hospital_name': hospital.name # Match Dashboard.jsx
            },
        })
    ...
    return jsonify({
        ...
        'user': {
            'id': staff.id,
            'name': staff.name,
            'fullName': staff.name, # Match Dashboard.jsx
            'email': staff.email,
            'role': staff.role,
            'hospital': hospital.name if hospital else None,
            'hospital_name': hospital.name if hospital else "Nexus Clinic" # Match Dashboard.jsx
        },
    })